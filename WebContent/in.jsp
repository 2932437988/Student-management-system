...
<head>
    ...
    <script type="text/javascript">
        function check() {
            var admissionreason = $("#admissionreason").val();
            ...
            if (admissionreason == '' || admissionreason == null) {
                alert("请填写入校事由!");
                return false;
            }
...
<body>
    ...
    <div align="center" style="padding-top: 10px;">
        <font color="#871F78" size="10">入校申请表</font>
    </div>
    <form class="form-horizontal" action="TripinSave" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="admissiontime" class="col-sm-4 control-label">入校时间</label>

            <div class="col-sm-4">
                <div class='input-group date' id='admissiontime'>
        ...
        <div class="form-group">
            <label for="admissionreason" class="col-sm-4 control-label">入校事由</label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="admissionreason" name="admissionreason"
                    placeholder="请输入入校事由">
            </div>
        </div>
        <div class="form-group">

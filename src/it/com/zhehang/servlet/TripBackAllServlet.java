 ...
 */
public class TripBackAllServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray=JsonUtils.formatRsToJsonArray(tripDao.tripAllBack(coon, newPage,trip));

...
/**
 * Servlet implementation class UserTripBackNOServlet
 */
public class UserTripBackNoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray=JsonUtils.formatRsToJsonArray(tripbackDao.ListNo(coon,tripback));

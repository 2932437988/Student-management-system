...
public class TripAllServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray0 = JsonUtils.formatRsToJsonArray(tripDao.tripAll0(coon, newPage,trip));
			JSONArray jsonArray1 = JsonUtils.formatRsToJsonArray(tripDao.tripAll1(coon, newPage,trip));
			JSONArray jsonArray2 = JsonUtils.formatRsToJsonArray(tripDao.tripAll2(coon, newPage,trip));
			JSONArray jsonArray=jsonArray0;

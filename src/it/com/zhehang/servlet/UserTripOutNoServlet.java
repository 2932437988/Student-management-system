 ...
 */
public class UserTripOutNoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray=JsonUtils.formatRsToJsonArray(tripoutDao.ListNo(coon,tripout));

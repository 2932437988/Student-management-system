 ...
 */
public class UserTripBackServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray=JsonUtils.formatRsToJsonArray(tripbackDao.List(coon,tripback));

...
/**
 * Servlet implementation class TripBackDeleteServlet
 */
public class TripBackDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		tripback.setSubtime(DateUtils.formatString(subtime, "yyyy-MM-dd HH:mm:ss"));
		tripback.setCategory(Integer.parseInt(category));
		coon = JBUtils.getConnection();
		JSONObject result=new JSONObject();
		int count1=tripDao.deleteTrip(coon, trip);
		coon=null;
		coon = JBUtils.getConnection();
		int count2=tripbackDao.deleteTripback(coon, tripback);

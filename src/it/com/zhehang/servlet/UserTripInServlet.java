 ...
 */
public class UserTripInServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONArray jsonArray=JsonUtils.formatRsToJsonArray(tripinDao.List(coon,tripin));
